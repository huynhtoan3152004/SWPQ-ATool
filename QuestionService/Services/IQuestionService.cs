...
{
    Task<QuestionResponse> CreateAsync(Guid askedBy, CreateQuestionRequest request, bool autoAssignToTopicLecturer = false, Guid? approvedBy = null, CancellationToken cancellationToken = default);
    ...
    Task<QuestionResponse?> AssignToTopicLecturerAsync(Guid questionId, CancellationToken cancellationToken = default);
